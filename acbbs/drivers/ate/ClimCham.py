...
class ClimCham(object):
    ...
    def __init__(self, simulate = False):
        ...
        if not simulate:
            self.log.info("New climatic chamber instance at {0}".format(self.dcConf["ip"]))
            self._dev = ModbusClient(host=self.dcConf["ip"], auto_open=True, auto_close=True, timeout = TIMEOUT, unit_id=255)
            
        else:
            self.log.info("New climatic chamber instance in simulate")
    ...
    def status(self, value):
        self.log.debug("Set status : {}".format(value))
    ...
    def tempConsigne(self):
        ...
        self.log.debug("Get tempConsigne : {}".format(value))
    
    @tempConsigne.setter
    def tempConsigne(self,value):
        self.log.debug("Set tempConsigne : {}".format(value))
    ...
    def tempReal(self):
        ...
        self.log.debug("Get tempReal : {}".format(value))
