...
class RFSigGenV(object):
    ...
    def __init__(self, simulate = False):
        ...
        if not simulate:
            ...
            self.log.info("Init RFSigGen in Simulate")
    ...
    def errors(self):
        ...
        #             errList.append(err)
        #             self.log.debug("read error %s" % err)
        #     return errList
    ...
    def power(self, value):
        self.log.debug("Set power : {}".format(value))
