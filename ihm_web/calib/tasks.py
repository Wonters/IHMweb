...
class NetworkEquipment(object):
    ...
    def ping_one(self, IP):
        ...
        if response == 0:
            log.info("Network Equipement Active at adresse:{0}".format(IP))
            return 0
        else:
            log.error('Network Equipement Error : {0}'.format(IP))
            return 1
...
class Calibration(object):
    def __init__(self, simu):
        ...
        ProgressCalib.current = 0
        ProgressCalib.total = 0
        self.iteration = 0
        self.totalProgress = 0

        self.paths = LIST_PATH

        ProgressCalib.message = ""
        self.message = ""
        self.response = 0
    ...
    def calibrate(self, tab_freq, pwr):
        ...
        ProgressCalib.total = (len(INPUTS) - 2 + len(OUTPUTS)) * len(tab_freq)
    ...
    def SMBCal(self):
        ...
        while self.response == 0:
            ProgressCalib.message  = " calibration of SMB, plug the power meter cal to J9 "
        ...
        for channel in self.channels:
            ...
            while self.response == 0:
                ProgressCalib.message = " plug the power meter cal to {0}".format(channel + 8)
    ...
    def SMBVCal(self):
        ...
        while self.response == 0:
            ProgressCalib.message = "plug the power meter cal to J9 "
    ...
    def PwrMeterCal(self):
        ...
        while self.response == 0:
            ProgressCalib.message = "plug the RF generator cal to J9"
    ...
    def NoiseCal(self):
        ...
        while self.response == 0:
            ProgressCalib.message = "plug the RF generator cal to J18 and the power meter to J9"
